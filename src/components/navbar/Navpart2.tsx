    ...
    <div>
      <div className="flex flex-1 items-center justify-between space-x-2 md:justify-end">
        ...
        <nav className="flex items-center ">
          ...
          <a target="_blank" rel="noreferrer" href="https://x.com/guri_who">
            <div className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:hover:border-white/20 hover:border rounded-full w-9 p-0 h-9">
              <svg
          ...
          <div>
            <button
              className="inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:hover:border-white/20 hover:border rounded-full size-10 w-9 p-0 h-9 relative group"
